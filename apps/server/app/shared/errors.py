...
def sos_rate_limit() -> AbhayaError:
    return _err("SOS_RATE_LIMIT", "You have created too many incidents recently. Please wait before starting another.", 429)

def sos_location_required() -> AbhayaError:
    return _err("SOS_LOCATION_REQUIRED", "Location is required to create an SOS.", 422)
